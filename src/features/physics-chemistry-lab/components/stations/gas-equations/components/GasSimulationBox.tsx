    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', height: '100%' }}>
      <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <span style={{ fontFamily: 'var(--as-font-title)', fontSize: '11px', color: 'color-mix(in srgb, var(--as-accent-cyan) 75%, var(--as-text-primary) 25%)', marginBottom: '8px' }}>GAZ PARFAIT (Théorique)</span>
          <canvas
            ref={idealCanvasRef}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <span style={{ fontFamily: 'var(--as-font-title)', fontSize: '11px', color: 'color-mix(in srgb, var(--as-accent-magenta) 75%, var(--as-text-primary) 25%)', marginBottom: '8px' }}>GAZ RÉEL (Van der Waals)</span>
          <canvas
            ref={vdwCanvasRef}
            width={240} height={200}
            style={{ background: 'var(--surface-inverse)', border: '1px solid var(--as-border-inverse)', borderRadius: '8px' }}
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '8px', padding: '8px', background: 'var(--surface-card)', borderRadius: '8px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: '16px' }}>
          <span style={{ fontSize: '10px', color: 'var(--as-text-muted)' }}>Densité part.</span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: '8px' }}>
          <span style={{ fontSize: '10px', color: 'var(--as-text-muted)' }}>Vitesse sim.</span>
      ...
      <div style={{ fontSize: '10px', color: 'var(--as-text-muted)', textAlign: 'center', fontStyle: 'italic' }}>
        * Représentation pédagogique simplifiée — la taille des particules et les distances ne sont pas à l'échelle.
      </div>
    </div>
  );
};
